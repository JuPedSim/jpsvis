...
{
     Debug::Info("Enter Settings::slotPickPedestrianColor()");
...
{
     Debug::Info("Enter Settings::slotChangePedestrianColor()");
...
{
     Debug::Info("Enter Settings::sloChangeVerticesWidth()");
    bool ok=false;
...
{
     Debug::Info("Enter Settings::slotChangePedestrianColorProfile()");
...
{
     Debug::Info("Enter Settings::slotPickCaptionColor()");
    QColorDialog* colorDialog = new QColorDialog(this);
...
{
     Debug::Info("Enter slotChangeCaptionColorMode()");
...
{
     Debug::Info("Enter Settings::closeEvent()");
    hide();
    ///@FIXME
    event->ignore();
}
